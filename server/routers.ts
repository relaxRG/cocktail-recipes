...
- 这类条目 type 输出 "material",category 按性质填:新鲜果蔬/香草香料/糖类甜味剂/蛋奶乳制品/茶与咖啡/其他原料
...
{"items":[{
  ...
  "category":"bottle分类,如 金酒/威士忌/利口酒/苦精/糖浆/果汁/软饮;material分类,如 新鲜果蔬/香草香料/糖类甜味剂","style":"风格子分类,如 London Dry/Bourbon","brand":"品牌","origin":"产地","volume":"规格如 700ml/500g/1斤","abv":40,"priceCny":0,
