...
const dict = {
  ...
  // ── 联网识别补全 ──────────────────────────────────────────────────────────
  "lookup.btn": { zh: "联网识别补全", en: "Look up online" },
  "lookup.photo": { zh: "拍瓶识别", en: "Scan bottle" },
  "lookup.filled": { zh: "已自动补全资料", en: "Info filled in automatically" },
  "lookup.notFound": { zh: "未找到匹配产品,请手动填写", en: "No match found, please fill in manually" },
  "lookup.needName": { zh: "请先填写产品名称", en: "Enter a product name first" },
  "lookup.enriching": { zh: "正在识别…", en: "Looking up…" },
  ...
  "book.pick.hint": { zh: "支持 EPUB / PDF", en: "Supports EPUB / PDF" },
  "book.ocr.hint": { zh: "扫描版 PDF 将使用 AI 识别文字", en: "Scanned PDFs use AI text recognition" },
  "book.parsing": { zh: "正在解析文件…", en: "Parsing file…" },
  "book.detecting": { zh: "正在检测配方…", en: "Detecting recipes…" },
  "book.translating": { zh: "正在翻译…", en: "Translating…" },
  "book.found": { zh: "发现 {n} 个配方候选", en: "Found {n} recipe candidates" },
  "book.none": { zh: "未检测到配方,请尝试其他文件", en: "No recipes detected. Try another file." },
  "book.selectAll": { zh: "全选", en: "Select All" },
  "book.deselectAll": { zh: "取消全选", en: "Deselect All" },
  "book.import": { zh: "导入选中 ({n})", en: "Import selected ({n})" },
  "book.importing": { zh: "正在导入…", en: "Importing…" },
  "book.done": { zh: "已导入 {n} 个配方", en: "Imported {n} recipes" },
  "book.translate.btn": { zh: "翻译为中文", en: "Translate to English" },
  "book.preview": { zh: "预览", en: "Preview" },
  "book.error.parse": { zh: "文件解析失败,请检查格式", en: "Failed to parse file. Check the format." },
  "book.error.ocr": { zh: "AI 识别失败,请重试", en: "AI recognition failed. Please retry." },
} as const;
