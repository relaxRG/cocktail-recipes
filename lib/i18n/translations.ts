...
const dict = {
  ...
  "hm.subtitle": { zh: "{n} 个自制原料 · 糖浆、浸渍与预调", en: "{n} homemade preps · syrups, infusions & batches" },
  "hm.search.placeholder": { zh: "搜索名称、原料…", en: "Search name, ingredient…" },
  "hm.empty.title": { zh: "还没有自制原料", en: "No homemade preps yet" },
  "hm.empty.desc": {
    zh: "记录自制糖浆、浸渍酒与预调批次,或导入常用示例",
    en: "Track syrups, infusions and batches, or import common samples",
  },
